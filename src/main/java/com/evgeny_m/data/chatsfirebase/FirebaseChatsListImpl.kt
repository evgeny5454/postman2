...
import com.evgeny_m.data.models.UserIdModel
import com.evgeny_m.data.utils.NODE_MESSAGES
import com.evgeny_m.data.utils.getMessageModel
...
class FirebaseChatsListImpl : FirebaseChatsList {
    ...
    private var lastMessages = mutableListOf<DataChatsList>()
